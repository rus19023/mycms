...
export const MOCKDOCUMENTS: any[] = [
  ...
  },
  {
    ...
    children: [
      {id: 12, dname: 'Case 1 – Defining the requirements', url: 'https://rkjackson.wordpress.com/cases/case-1/'},
      {id: 13, dname: 'Case 2 – User Interface design', url: 'https://rkjackson.wordpress.com/cases/case-2/'},
      {
        id: 14, dname: 'Case 3 – Implementing Model Layer', url: 'https://rkjackson.wordpress.com/cases/case-3/',
        children: [
          {'id': 36, dname: 'Team Assignment', 'description': 'Create your first JavaBean class'}
          , {'id': 37, dname: 'Individual Assignment', 'description': 'Create remaining JavaBean classes'}
        ]
      },
      {id: 15, dname: 'Case 4 – Enterprise Java Session Beans', url: 'https://rkjackson.wordpress.com/cases/case-4/'},
      {id: 16, dname: 'Case 5 – Implementing the View', url: 'https://rkjackson.wordpress.com/cases/case-5/'},
      {id: 17, dname: 'Case 6 – A Framework for the View Layer', url: 'https://rkjackson.wordpress.com/cases/case-6/'}
    ]
  },
  {
    id: 20,
